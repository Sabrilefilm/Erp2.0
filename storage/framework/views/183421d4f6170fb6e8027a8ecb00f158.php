...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Ultra'); ?></title>
...
?>
    ...
    <div class="relative z-10 flex flex-col min-h-screen">
        ...
        <aside class="app-sidebar" id="app-sidebar" aria-label="Menu principal">
            <div class="app-sidebar-logo">
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2 no-underline text-white font-bold" aria-label="Ultra - Accueil">
            ...
            <nav class="app-sidebar-nav">
                <a href="<?php echo e(route('dashboard')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('dashboard') ? 'is-active' : ''); ?>">
                ...
                <?php if(auth()->user()->isFondateur()): ?>
                
                <div class="app-sidebar-nav-group nav-dropdown <?php echo e((request()->routeIs('users.*') || request()->routeIs('password.generate-code*') || request()->routeIs('blacklist.*') || request()->routeIs('score-integrite.gestion') || request()->routeIs('import.*') || request()->routeIs('rapport-vendredi.*') || request()->routeIs('donnees-match.*')) ? 'is-open' : ''); ?>" data-nav-dropdown>
                    <button type="button" class="app-sidebar-nav-item nav-dropdown-trigger w-full text-left flex items-center justify-between gap-2 cursor-pointer border-0 bg-transparent" aria-expanded="<?php echo e((request()->routeIs('users.*') || request()->routeIs('import.*') || request()->routeIs('rapport-vendredi.*')) ? 'true' : 'false'); ?>" aria-controls="sidebar-dropdown-admin" id="sidebar-trigger-admin">
                    ...
                    <div class="nav-dropdown-panel" id="sidebar-dropdown-admin" role="region" aria-labelledby="sidebar-trigger-admin">
                        <a href="<?php echo e(route('users.index')); ?>" class="app-sidebar-nav-item pl-10 <?php echo e(request()->routeIs('users.*') ? 'is-active' : ''); ?>">
                            <span>Utilisateurs</span>
                        </a>
                        <a href="<?php echo e(route('password.generate-code.form')); ?>" class="app-sidebar-nav-item pl-10 <?php echo e(request()->routeIs('password.generate-code*') ? 'is-active' : ''); ?>">
                            <span>Générer un code mot de passe</span>
                        </a>
                        <a href="<?php echo e(route('blacklist.index')); ?>" class="app-sidebar-nav-item pl-10 <?php echo e(request()->routeIs('blacklist.*') ? 'is-active' : ''); ?>">
                            <span>Liste noire</span>
                        </a>
                        <?php if(auth()->user()->isFondateurPrincipal()): ?>
                        <a href="<?php echo e(route('score-integrite.gestion')); ?>" class="app-sidebar-nav-item pl-10 <?php echo e(request()->routeIs('score-integrite.gestion') ? 'is-active' : ''); ?>">
                            <span>Infractions (score)</span>
                        </a>
                        <a href="<?php echo e(route('import.index')); ?>" class="app-sidebar-nav-item pl-10 <?php echo e(request()->routeIs('import.index') || request()->routeIs('import.store') || request()->routeIs('import.template') ? 'is-active' : ''); ?>">
                            <span>Import Excel</span>
                        </a>
                        <a href="<?php echo e(route('import.corriger-heures-jours')); ?>" class="app-sidebar-nav-item pl-10 <?php echo e(request()->routeIs('import.corriger-heures-jours') || request()->routeIs('import.mettre-a-jour-heures-jours') ? 'is-active' : ''); ?>">
                            <span>Corriger heures et jours</span>
                        </a>
                        <a href="<?php echo e(route('rapport-vendredi.index')); ?>" class="app-sidebar-nav-item pl-10 <?php echo e(request()->routeIs('rapport-vendredi.*') ? 'is-active' : ''); ?>">
                            <span>Rapport de la semaine</span>
                        </a>
                        <a href="<?php echo e(route('donnees-match.index')); ?>" class="app-sidebar-nav-item pl-10 <?php echo e(request()->routeIs('donnees-match.*') ? 'is-active' : ''); ?>">
                            <span>Données match (répertoire)</span>
                        </a>
                        <?php endif; ?>
                    </div>
                </div>
                <?php elseif(!auth()->user()->isCreateur() && !auth()->user()->isAgent()): ?>
                <a href="<?php echo e(route('users.index')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('users.*') ? 'is-active' : ''); ?>">
                    <span class="app-sidebar-nav-icon"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg></span>
                    <span>Utilisateurs</span>
                </a>
                <?php if(auth()->user()->hasRoleOrAbove('manageur')): ?>
                <a href="<?php echo e(route('password.generate-code.form')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('password.generate-code*') ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('matches.index')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('matches.*') ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('createurs.mes-createurs')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('createurs.mes-createurs') ? 'is-active' : ''); ?>">
                    <span class="app-sidebar-nav-icon"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg></span>
                    <span>Mes créateurs</span>
                </a>
                <?php endif; ?>
                <a href="<?php echo e(route('recompenses.index')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('recompenses.*') ? 'is-active' : ''); ?>">
                ...
                <?php if(!auth()->user()->isCreateur() && !auth()->user()->isFondateur()): ?>
                <a href="<?php echo e(route('blacklist.index')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('blacklist.*') ? 'is-active' : ''); ?>">
                ...
                <?php endif; ?>
                <?php if(auth()->user()->canSeeScoreIntegrite()): ?>
                <a href="<?php echo e(route('score-integrite.index')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('score-integrite.*') ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('score-fidelite.index')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('score-fidelite.*') ? 'is-active' : ''); ?>">
                    <span class="app-sidebar-nav-icon"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"/></svg></span>
                    <span>Bonnes actions</span>
                </a>
                <?php if(!auth()->user()->isFondateur() && !auth()->user()->isCreateur()): ?>
                <a href="<?php echo e(route('rapport-vendredi.index')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('rapport-vendredi.*') ? 'is-active' : ''); ?>">
                ...
                <div class="app-sidebar-nav-group nav-dropdown <?php echo e(request()->routeIs('equipes.*') ? 'is-open' : ''); ?>" data-nav-dropdown>
                    <button type="button" class="app-sidebar-nav-item nav-dropdown-trigger w-full text-left flex items-center justify-between gap-2 cursor-pointer border-0 bg-transparent" aria-expanded="<?php echo e(request()->routeIs('equipes.*') ? 'true' : 'false'); ?>" aria-controls="sidebar-dropdown-agences" id="sidebar-trigger-agences">
                        <span class="flex items-center gap-3">
                    ...
                    <div class="nav-dropdown-panel" id="sidebar-dropdown-agences" role="region" aria-labelledby="sidebar-trigger-agences">
                        <a href="<?php echo e(route('equipes.index')); ?>" class="app-sidebar-nav-item pl-10 <?php echo e(request()->routeIs('equipes.index') || request()->routeIs('equipes.create') || request()->routeIs('equipes.edit') || request()->routeIs('equipes.membres') ? 'is-active' : ''); ?>">
                            <span>Liste des agences</span>
                        </a>
                        <a href="<?php echo e(route('equipes.attribution')); ?>" class="app-sidebar-nav-item pl-10 <?php echo e(request()->routeIs('equipes.attribution') ? 'is-active' : ''); ?>">
                ...
                <?php endif; ?>
                <?php if(auth()->user()->isFondateurPrincipal()): ?>
                <a href="<?php echo e(route('diagnostic.index')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('diagnostic.*') ? 'is-active' : ''); ?>">
                    <span class="app-sidebar-nav-icon"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg></span>
                    <span>Diagnostic</span>
                </a>
                <?php endif; ?>
                <div class="app-sidebar-divider"></div>
                <a href="<?php echo e(route('aide.index')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('aide.index') ? 'is-active' : ''); ?>">
                ...
                <a href="<?php echo e(route('documents-officiels.index')); ?>" class="app-sidebar-nav-item <?php echo e(request()->routeIs('documents-officiels.*') ? 'is-active' : ''); ?>">
                    <span class="app-sidebar-nav-icon"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg></span>
            ...
            <div class="app-sidebar-footer">
                <div class="app-sidebar-user">
                    <div class="app-sidebar-user-avatar"><?php echo e(strtoupper(mb_substr(auth()->user()->name, 0, 2))); ?></div>
                    <div>
                        <p class="app-sidebar-user-name"><?php echo e(auth()->user()->name); ?></p>
                        <p class="app-sidebar-user-role"><?php echo e(auth()->user()->getRoleLabel()); ?></p>
                    </div>
                </div>
            </div>
        </aside>
        ...
        <header class="app-header ultra-top-bar" id="app-header">
            ...
            <div class="app-header-actions ultra-top-bar-actions">
                ...
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    <button type="button" class="app-header-icon-btn relative <?php echo e(request()->routeIs('messagerie.*') ? 'is-active' : ''); ?> <?php echo e($unreadMessagesCount > 0 ? 'ultra-btn-message-pulse' : ''); ?>" aria-label="Messagerie" title="Messagerie" aria-haspopup="true" :aria-expanded="open" @click="open = !open">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
                        <?php if($unreadMessagesCount > 0): ?>
                        <span class="ultra-top-bar-badge"><?php echo e($unreadMessagesCount > 99 ? '99+' : $unreadMessagesCount); ?></span>
                        <?php endif; ?>
                    </button>
                    <div class="notifications-dropdown-panel messagerie-dropdown-panel fixed left-1/2 top-16 -translate-x-1/2 w-[min(480px,calc(100vw-2rem))] rounded-xl border border-white/20 shadow-2xl z-[100] overflow-y-auto overflow-x-hidden max-h-[85vh] bg-[#0f172a]" style="background-color: #0f172a; display: none;" x-show="open" x-transition x-cloak>
                        <div class="px-4 py-3 border-b border-white/10 flex items-center justify-between bg-[#0f172a] flex-shrink-0">
                            ...
                            <a href="<?php echo e(route('messagerie.index')); ?>" class="text-xs text-[#1877f2] hover:underline" @click="open = false">Voir tout</a>
                        </div>
                        <div class="max-h-[70vh] overflow-y-auto overflow-x-hidden bg-[#0f172a]">
                            <?php $__empty_1 = true; $__currentLoopData = $headerConversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php $other = $msg->sender_id === auth()->id() ? $msg->receiver : $msg->sender; ?>
                            <?php if($other): ?>
                            <a href="<?php echo e(route('messagerie.conversation', $other)); ?>" class="flex items-start gap-3 px-4 py-3 hover:bg-white/5 transition-colors break-words" @click="open = false">
                                <span class="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center flex-shrink-0 text-sm font-medium text-white/90"><?php echo e(strtoupper(mb_substr($other->name ?? '?', 0, 2))); ?></span>
                                <div class="min-w-0 flex-1 overflow-hidden">
                                    <p class="text-sm font-medium text-white truncate"><?php echo e($other->name ?? 'Utilisateur'); ?></p>
                                    <p class="text-sm text-[#94a3b8] leading-snug break-words" style="overflow-wrap: break-word; word-break: break-word;"><?php echo e(Str::limit($msg->contenu, 200)); ?></p>
                                    <p class="text-xs text-[#64748b] mt-0.5"><?php echo e($msg->created_at->diffForHumans()); ?></p>
                                </div>
                                <?php if($msg->receiver_id === auth()->id() && !$msg->read_at): ?><span class="w-2 h-2 rounded-full bg-[#1877f2] flex-shrink-0 mt-2" aria-hidden="true"></span><?php endif; ?>
                            </a>
                            <?php endif; ?>
                        ...
                        <div class="px-4 py-2 border-t border-white/10 bg-[#0f172a]">
                            <a href="<?php echo e(route('messagerie.index')); ?>" class="block text-center text-sm text-[#1877f2] hover:underline py-2" @click="open = false">Voir la messagerie</a>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    <button type="button" class="app-header-icon-btn ultra-top-bar-circle relative <?php echo e(request()->routeIs('notifications.*') ? 'is-active' : ''); ?>" aria-label="Notifications (<?php echo e($unreadNotificationsCount); ?> non lues)" title="Notifications" aria-haspopup="true" :aria-expanded="open" @click="open = !open">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                        <?php if($unreadNotificationsCount > 0): ?>
                        <span class="ultra-top-bar-badge"><?php echo e($unreadNotificationsCount > 99 ? '99+' : $unreadNotificationsCount); ?></span>
                        <?php endif; ?>
                    </button>
                    <div class="notifications-dropdown-panel fixed left-1/2 top-16 -translate-x-1/2 w-[min(480px,calc(100vw-2rem))] rounded-xl border border-white/20 shadow-2xl z-[100] overflow-y-auto overflow-x-hidden max-h-[85vh] bg-[#0f172a]" style="background-color: #0f172a; display: none;" x-show="open" x-transition x-cloak>
                        <div class="px-4 py-3 border-b border-white/10 flex items-center justify-between bg-[#0f172a] flex-shrink-0">
                            ...
                            <a href="<?php echo e(route('notifications.index')); ?>" class="text-xs text-[#1877f2] hover:underline" @click="open = false">Voir tout</a>
                        </div>
                        <div class="max-h-[70vh] overflow-y-auto overflow-x-hidden bg-[#0f172a]">
                            ...
                            <?php $data = is_array($notif->data) ? $notif->data : (array) $notif->data; ?>
                            <a href="<?php echo e(route('notifications.read', $notif->id)); ?>" class="flex items-start gap-3 px-4 py-3 hover:bg-white/5 transition-colors break-words <?php echo e($notif->read_at ? 'opacity-80' : ''); ?>" @click="open = false">
                                ...
                                <div class="min-w-0 flex-1 overflow-hidden">
                                    <p class="text-sm text-white leading-snug" style="overflow-wrap: break-word; word-break: break-word;"><?php echo e($data['message'] ?? 'Notification'); ?></p>
                                    <p class="text-xs text-[#64748b] mt-0.5"><?php echo e($notif->created_at->diffForHumans()); ?></p>
                                </div>
                                <?php if(!$notif->read_at): ?><span class="w-2 h-2 rounded-full bg-[#1877f2] flex-shrink-0 mt-2" aria-hidden="true"></span><?php endif; ?>
                            </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <div class="px-4 py-2 border-t border-white/10 bg-[#0f172a]">
                            <a href="<?php echo e(route('notifications.index')); ?>" class="block text-center text-sm text-[#1877f2] hover:underline py-2" @click="open = false">Voir toutes les notifications</a>
                        </div>
                    </div>
                </div>
                <div class="app-header-dropdown-wrap" x-data="{ open: false }" @click.outside="open = false">
                    <button type="button" class="app-header-avatar-btn ultra-top-bar-avatar" aria-label="Menu compte" aria-haspopup="true" :aria-expanded="open" @click="open = !open">
                        <span class="ultra-avatar-initials"><?php echo e(strtoupper(mb_substr(auth()->user()->name, 0, 2))); ?></span>
        ...
        <header class="md:hidden fixed top-0 left-0 right-0 h-14 z-30 ultra-header ultra-top-bar-mobile flex items-center justify-between px-4">
            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2 no-underline">
            ...
            <div class="flex items-center gap-1">
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    <button type="button" class="relative flex items-center justify-center w-10 h-10 rounded-full text-white hover:text-white hover:bg-white/15 transition-colors <?php echo e($unreadNotificationsCount > 0 ? 'ultra-btn-notif-mobile-pulse' : ''); ?>" aria-label="Notifications (<?php echo e($unreadNotificationsCount); ?> non lues)" title="Notifications" @click="open = !open">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                        <?php if($unreadNotificationsCount > 0): ?>
                        <span class="ultra-top-bar-badge absolute top-0.5 right-0.5 min-w-[18px] h-[18px] flex items-center justify-center rounded-full bg-red-500 text-white text-[10px] font-bold"><?php echo e($unreadNotificationsCount > 99 ? '99+' : $unreadNotificationsCount); ?></span>
                        <?php endif; ?>
                    </button>
                    ...
                    <div class="notifications-dropdown-panel ultra-notif-mobile fixed top-[3.75rem] md:hidden inset-x-3 max-h-[80vh] rounded-xl border-2 border-white/25 shadow-2xl z-[120] overflow-y-auto overflow-x-hidden bg-[#0f172a] box-border" style="background-color: #0f172a; display: none;" x-show="open" x-transition x-cloak>
                        <div class="px-4 py-3 border-b border-white/10 flex items-center justify-between gap-2 bg-[#0f172a] flex-shrink-0 min-w-0">
                            ...
                            <a href="<?php echo e(route('notifications.index')); ?>" class="text-xs text-[#1877f2] hover:underline flex-shrink-0 whitespace-nowrap" @click="open = false">Voir tout</a>
                        </div>
                        <div class="max-h-[75vh] overflow-y-auto overflow-x-hidden bg-[#0f172a]">
                            <?php $__empty_1 = true; $__currentLoopData = $headerNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php $data = is_array($notif->data) ? $notif->data : (array) $notif->data; ?>
                            <a href="<?php echo e(route('notifications.read', $notif->id)); ?>" class="flex items-start gap-3 px-4 py-3 hover:bg-white/5 transition-colors <?php echo e($notif->read_at ? 'opacity-80' : ''); ?> min-w-0" @click="open = false">
                                <span class="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center flex-shrink-0">
                                    <svg class="w-4 h-4 text-[#94a3b8]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                                </span>
                                <div class="min-w-0 flex-1 overflow-hidden" style="max-width: 100%;">
                                    <p class="text-sm text-white leading-snug break-words" style="overflow-wrap: break-word; word-break: break-word; hyphens: auto;"><?php echo e($data['message'] ?? 'Notification'); ?></p>
                                    <p class="text-xs text-[#64748b] mt-0.5"><?php echo e($notif->created_at->diffForHumans()); ?></p>
                                </div>
                                <?php if(!$notif->read_at): ?><span class="w-2 h-2 rounded-full bg-[#1877f2] flex-shrink-0 mt-2" aria-hidden="true"></span><?php endif; ?>
                            </a>
                        ...
                        <div class="px-4 py-2 border-t border-white/10 bg-[#0f172a] min-w-0">
                            <a href="<?php echo e(route('notifications.index')); ?>" class="block text-center text-sm text-[#1877f2] hover:underline py-2 break-words" style="overflow-wrap: break-word;" @click="open = false">Voir toutes les notifications</a>
                        </div>
                    </div>
                </div>
                <?php if(auth()->user()->hasRoleOrAbove('agent') || auth()->user()->isCreateur()): ?>
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    <button type="button" class="ultra-btn-message-mobile relative flex items-center justify-center w-10 h-10 rounded-full text-white/80 hover:text-white hover:bg-white/10 transition-all duration-200 <?php echo e($unreadMessagesCount > 0 ? 'ultra-btn-message-pulse' : ''); ?>" aria-label="Messagerie" title="Messagerie" @click="open = !open">
                    ...
                    <div class="notifications-dropdown-panel messagerie-dropdown-panel ultra-msg-mobile fixed top-[3.75rem] md:hidden inset-x-3 max-h-[55vh] rounded-xl border border-white/20 shadow-2xl z-[110] overflow-y-auto overflow-x-hidden bg-[#0f172a] box-border" style="background-color: #0f172a; display: none;" x-show="open" x-transition x-cloak>
                        <div class="px-3 py-2 border-b border-white/10 flex items-center justify-between bg-[#0f172a] flex-shrink-0">
                            ...
                            <a href="<?php echo e(route('messagerie.index')); ?>" class="text-[10px] text-[#1877f2] hover:underline flex-shrink-0" @click="open = false">Voir tout</a>
                        </div>
                        <div class="max-h-[42vh] overflow-y-auto overflow-x-hidden bg-[#0f172a]">
                            <?php $__empty_1 = true; $__currentLoopData = $headerConversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php $other = $msg->sender_id === auth()->id() ? $msg->receiver : $msg->sender; ?>
                            <?php if($other): ?>
                            <a href="<?php echo e(route('messagerie.conversation', $other)); ?>" class="flex items-center gap-2 px-3 py-2 hover:bg-white/5 transition-colors min-w-0" @click="open = false">
                                <span class="w-7 h-7 rounded-full bg-white/10 flex items-center justify-center flex-shrink-0 text-[10px] font-medium text-white/90"><?php echo e(strtoupper(mb_substr($other->name ?? '?', 0, 2))); ?></span>
                                <div class="min-w-0 flex-1 overflow-hidden" style="max-width: 100%;">
                                    <p class="text-xs font-medium text-white truncate"><?php echo e($other->name ?? 'Utilisateur'); ?></p>
                                    <p class="text-[10px] text-[#94a3b8] break-words" style="overflow-wrap: break-word; word-break: break-word; hyphens: auto;"><?php echo e(Str::limit($msg->contenu, 150)); ?></p>
                                </div>
                                <span class="text-[9px] text-[#64748b] flex-shrink-0"><?php echo e($msg->created_at->diffForHumans()); ?></span>
                                <?php if($msg->receiver_id === auth()->id() && !$msg->read_at): ?><span class="w-1.5 h-1.5 rounded-full bg-[#1877f2] flex-shrink-0" aria-hidden="true"></span><?php endif; ?>
                            </a>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <div class="px-3 py-1.5 border-t border-white/10 bg-[#0f172a]">
                            <a href="<?php echo e(route('messagerie.index')); ?>" class="block text-center text-[10px] text-[#1877f2] hover:underline py-1.5" @click="open = false">Voir la messagerie</a>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="ultra-menu-panel ultra-bottom-sheet-panel menu-drawer-modern flex flex-col rounded-t-3xl">
                ...
                <div class="menu-drawer-profile flex-shrink-0 px-5 py-4">
                    <div class="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#00d4ff] to-[#a78bfa] flex items-center justify-center font-bold text-white text-lg shadow-lg shadow-indigo-500/20 flex-shrink-0"><?php echo e(strtoupper(mb_substr(auth()->user()->name, 0, 2))); ?></div>
                        <div class="min-w-0 flex-1">
                            <p class="font-bold text-white truncate text-base"><?php echo e(auth()->user()->name); ?></p>
                            <p class="text-sm text-[#94a3b8] truncate mt-0.5"><?php echo e(auth()->user()->phone ?: auth()->user()->getRoleLabel()); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="ultra-menu-panel-scroll flex-1 min-h-0 overflow-y-auto py-1">
                    <nav class="px-4 space-y-0.5">
                        <a href="<?php echo e(route('dashboard')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('dashboard') ? 'is-active' : ''); ?>">
                        ...
                        <div class="nav-dropdown <?php echo e((request()->routeIs('users.*') || request()->routeIs('password.generate-code*') || request()->routeIs('blacklist.*') || request()->routeIs('score-integrite.gestion') || request()->routeIs('import.*') || request()->routeIs('rapport-vendredi.*') || request()->routeIs('donnees-match.*')) ? 'is-open' : ''); ?>" data-nav-dropdown>
                            <button type="button" class="menu-drawer-dropdown-trigger w-full flex items-center justify-between gap-2 px-4 py-3 rounded-xl text-left text-[#94a3b8] text-xs font-semibold uppercase tracking-wider cursor-pointer border-0 bg-transparent hover:bg-white/5 hover:text-white transition-colors" aria-expanded="<?php echo e((request()->routeIs('users.*') || request()->routeIs('import.*') || request()->routeIs('rapport-vendredi.*')) ? 'true' : 'false'); ?>" aria-controls="drawer-dropdown-admin" id="drawer-trigger-admin">
                                <span>Administration</span>
                                <span class="nav-dropdown-chevron w-4 h-4 flex-shrink-0 transition-transform duration-200" aria-hidden="true"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg></span>
                            </button>
                            <div class="nav-dropdown-panel" id="drawer-dropdown-admin" role="region" aria-labelledby="drawer-trigger-admin">
                                <a href="<?php echo e(route('users.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('users.*') ? 'is-active' : ''); ?>">
                            <span class="menu-drawer-icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg></span>
                            Utilisateurs
                        </a>
                        <a href="<?php echo e(route('password.generate-code.form')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('password.generate-code*') ? 'is-active' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('blacklist.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('blacklist.*') ? 'is-active' : ''); ?>">
                        ...
                        <?php if(auth()->user()->isFondateurPrincipal()): ?>
                        <a href="<?php echo e(route('score-integrite.gestion')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('score-integrite.gestion') ? 'is-active' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('import.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('import.index') || request()->routeIs('import.store') || request()->routeIs('import.template') ? 'is-active' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('import.corriger-heures-jours')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('import.corriger-heures-jours') || request()->routeIs('import.mettre-a-jour-heures-jours') ? 'is-active' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('rapport-vendredi.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('rapport-vendredi.*') ? 'is-active' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('donnees-match.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('donnees-match.*') ? 'is-active' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('matches.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('matches.*') ? 'is-active' : ''); ?>">
                            <span class="menu-drawer-icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg></span>
                            Matchs
                        </a>
                        <?php if(auth()->user()->isAgent()): ?>
                        <a href="<?php echo e(route('createurs.mes-createurs')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('createurs.mes-createurs') ? 'is-active' : ''); ?>">
                            <span class="menu-drawer-icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg></span>
                            Mes créateurs
                        </a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('recompenses.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('recompenses.*') ? 'is-active' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('regles.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('regles.*') ? 'is-active' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('formations.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('formations.*') ? 'is-active' : ''); ?>">
                        ...
                        <?php endif; ?>
                        <?php if(auth()->user()->canSeeScoreIntegrite()): ?>
                        <a href="<?php echo e(route('score-integrite.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('score-integrite.*') ? 'is-active' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('score-fidelite.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('score-fidelite.*') ? 'is-active' : ''); ?>">
                            <span class="menu-drawer-icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"/></svg></span>
                            Bonnes actions
                        </a>
                        <?php if(!auth()->user()->isFondateur() && !auth()->user()->isCreateur()): ?>
                        ...
                        <div class="nav-dropdown <?php echo e(request()->routeIs('equipes.*') ? 'is-open' : ''); ?>" data-nav-dropdown>
                            ...
                            <div class="nav-dropdown-panel" id="drawer-dropdown-agences" role="region" aria-labelledby="drawer-trigger-agences">
                                <a href="<?php echo e(route('equipes.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('equipes.index') || request()->routeIs('equipes.create') || request()->routeIs('equipes.edit') || request()->routeIs('equipes.membres') ? 'is-active' : ''); ?>">
                                ...
                                <a href="<?php echo e(route('equipes.attribution')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('equipes.attribution') ? 'is-active' : ''); ?>">
                                    <span class="menu-drawer-icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg></span>
                                    Attribution agences
                                </a>
                            </div>
                        ...
                        <?php endif; ?>
                        <?php if(auth()->user()->isFondateurPrincipal()): ?>
                        <a href="<?php echo e(route('diagnostic.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('diagnostic.*') ? 'is-active' : ''); ?>">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(route('aide.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('aide.index') ? 'is-active' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('documents-officiels.index')); ?>" class="menu-drawer-link <?php echo e(request()->routeIs('documents-officiels.*') ? 'is-active' : ''); ?>">
                            <span class="menu-drawer-icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg></span>
        ...
        <main class="app-main ultra-main ultra-main-modern dashboard-main flex-1 overflow-auto p-4 <?php echo e(request()->routeIs('messagerie.*') ? 'pb-2' : 'pb-24'); ?> md:pb-8 min-h-screen" id="main-content">
            <?php if(session('success')): ?>
                <div class="mb-4 p-3 rounded-xl bg-neon-green/10 text-neon-green border border-neon-green/30"><?php echo e(session('success')); ?></div>
            <?php endif; ?>
            <?php if(session('warning')): ?>
                <div class="mb-4 p-3 rounded-xl bg-neon-orange/10 text-neon-orange border border-neon-orange/30"><?php echo e(session('warning')); ?></div>
            <?php endif; ?>
            <?php if(session('error')): ?>
                <div class="mb-4 p-3 rounded-xl bg-neon-pink/10 text-neon-pink border border-neon-pink/30"><?php echo e(session('error')); ?></div>
            <?php endif; ?>
            <?php if($errors->any()): ?>
    ...
    <nav role="navigation" aria-label="Navigation principale" class="ultra-bottom-nav-bar ultra-bottom-nav md:hidden flex items-center justify-around h-[75px] px-2" style="position:fixed; top:auto; bottom:0; left:0; right:0; z-index:40; padding-bottom:env(safe-area-inset-bottom,0);">
        <a href="<?php echo e(route('dashboard')); ?>" aria-label="Accueil" class="flex flex-col items-center justify-center flex-1 py-2 transition-all <?php echo e(request()->routeIs('dashboard') ? 'nav-link-active-1' : 'text-white/50 hover:text-white/80'); ?>">
            <svg class="w-7 h-7 mb-1" fill="<?php echo e(request()->routeIs('dashboard') ? 'currentColor' : 'none'); ?>" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
            <span class="text-[0.65rem] font-medium">Accueil</span>
        </a>
        <?php if(auth()->user()->isCreateur()): ?>
        <a href="<?php echo e(route('createurs.index')); ?>" aria-label="Ma fiche" class="flex flex-col items-center justify-center flex-1 py-2 transition-all <?php echo e(request()->routeIs('createurs.show') ? 'nav-link-active-2' : 'text-white/50 hover:text-white/80'); ?>">
            <svg class="w-7 h-7 mb-1" fill="<?php echo e(request()->routeIs('createurs.show') ? 'currentColor' : 'none'); ?>" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
            <span class="text-[0.65rem] font-medium">Ma fiche</span>
        </a>
        <?php elseif(auth()->user()->isAgent()): ?>
        <a href="<?php echo e(route('createurs.mes-createurs')); ?>" aria-label="Mes créateurs" class="flex flex-col items-center justify-center flex-1 py-2 transition-all <?php echo e(request()->routeIs('createurs.mes-createurs') ? 'nav-link-active-2' : 'text-white/50 hover:text-white/80'); ?>">
        ...
        <?php else: ?>
        <a href="<?php echo e(route('users.index')); ?>" aria-label="Utilisateurs" class="flex flex-col items-center justify-center flex-1 py-2 transition-all <?php echo e(request()->routeIs('users.*') ? 'nav-link-active-2' : 'text-white/50 hover:text-white/80'); ?>">
...
<?php /**PATH /Users/sabri/Documents/ERP Unions V2/resources/views/layouts/app.blade.php ENDPATH**/ ?>