<?php $__env->startSection('title', 'Générer un code de réinitialisation'); ?>
...
<div class="space-y-6 pb-8 max-w-xl mx-auto">
    ...
    <?php if(session('generated_code')): ?>
        ...
        <div class="pwd-card pwd-card-delay-1 rounded-2xl border-2 border-emerald-500/40 bg-gradient-to-br from-emerald-950/50 to-emerald-900/40 p-6 md:p-8 shadow-xl text-center">
            ...
            <p class="text-sm text-white/80 mb-4">Pour <strong class="text-white"><?php echo e(session('generated_for_user')); ?></strong> (<?php echo e(session('generated_for_username')); ?>)</p>

            <div class="pwd-code-box mt-4 mb-5 rounded-2xl bg-black/40 border border-emerald-500/40 py-6 px-6">
                <p class="pwd-code-text text-2xl md:text-4xl font-mono font-bold text-emerald-300 tracking-[0.2em] select-all" id="generated-code"><?php echo e(session('generated_code')); ?></p>
            </div>
            ...
            <div class="flex flex-col items-center gap-1 mb-5">
                ...
                <div id="pwd-countdown" class="pwd-timer text-2xl md:text-3xl font-mono font-bold text-amber-300 tabular-nums" data-expires-at="<?php echo e(session('code_expires_at')->getTimestamp()); ?>">
                    --:--
                </div>
                <p id="pwd-countdown-done" class="text-sm font-medium text-rose-400 hidden">Code expiré</p>
            </div>

            <p class="text-xs text-[#94a3b8] mb-4">Valide jusqu'à <strong class="text-white/80"><?php echo e(session('code_expires_at')->format('d/m/Y à H:i')); ?></strong>. Transmettez ce code en toute sécurité.</p>
    ...
    <div class="pwd-card pwd-card-delay-2 ultra-card rounded-2xl p-6 border border-white/10 shadow-lg">
        ...
        <form action="<?php echo e(route('password.generate-code')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
                ...
                <select name="user_id" id="user_id" required class="ultra-input w-full px-3 py-2.5 rounded-xl text-white border border-white/10 focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/30 transition-colors">
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($u->id); ?>" <?php echo e(old('user_id') == $u->id ? 'selected' : ''); ?>>
                            <?php echo e($u->name); ?> (<?php echo e($u->username); ?>) — <?php echo e($u->getRoleLabel()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/sabri/Documents/ERP Unions V2/resources/views/auth/passwords/generate-code.blade.php ENDPATH**/ ?>