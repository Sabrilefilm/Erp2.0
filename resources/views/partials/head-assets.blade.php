{{-- Alpine.js cloak (évite le flash avant hydratation) --}}
...
{{-- Charge Vite (build) ou Tailwind CDN en secours si le build n'existe pas --}}
@if(file_exists(public_path('build/manifest.json')))
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    <link rel="stylesheet" href="{{ asset('css/dashboard-layout.css') }}">
@else
    <link rel="stylesheet" href="{{ asset('css/ultra-ui.css') }}">
    <link rel="stylesheet" href="{{ asset('css/ultra-premium.css') }}">
    <link rel="stylesheet" href="{{ asset('css/dashboard-layout.css') }}">
